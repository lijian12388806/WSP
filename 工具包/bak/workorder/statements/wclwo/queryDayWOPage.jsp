...
<form id="pagerForm" method="post"
	action="${applicationScope.rootpath}listDayWclwo.action">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="listDayWclwo.action" method="post" name="listDayWclwo">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>
						统计时间:
						<input name="querywoday" id="querywoday" value="${querywoday}"
							...
							<ul>
								...
								<li>
									<div class="buttonActive">
										<div class="buttonContent">
											<button type="button"
												onclick="getValue(document.forms['listDayWclwo']);">
												清除
											</button>
										</div>
									</div>
...
<div class="panelBar">
	...
	<table class="table" layoutH="116" nowrapTD="false" width="100%">
		...
		<tbody>
			<c:forEach var="item" items="${sessionScope.liststfday}">
				<tr>
					<td>
						${item.subdate}
					</td>
