...
<form id="pagerForm" method="post"
	action="${applicationScope.rootpath}listYearWclwo.action">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="listYearWclwo.action" method="post" name="listYearWclwo">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td>
						统计时间:
						<input name="querywoyear" id="querywoyear" value="${querywoyear}"
							type="text" size="20" class="date" format="yyyy" yearstart="0"
							yearend="100" />
					</td>
					<td>
						未处理工单数:
							...
							<ul>
								...
								<li>
									<div class="buttonActive">
										<div class="buttonContent">
											<button type="button"
												onclick="getValue(document.forms['listYearWclwo']);">
												清除
											</button>
										</div>
									</div>
...
<div class="panelBar">
	...
	<table class="table" layoutH="116" nowrapTD="false" width="100%">
		...
		<tbody>
			<c:forEach var="item" items="${sessionScope.liststfyear}">
				<tr>
					<td>
						${item.subdate}
					</td>
