...
<form id="pagerForm" method="post"
	action="${applicationScope.rootpath}listYearStwo.action">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="listYearStwo.action" method="post" name="listYearStwo">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td>
						统计时间:
						<input name="querystwoyear" id="querystwoyear"
							value="${querystwoyear}" type="text" size="20" class="date"
							format="yyyy" yearstart="0" yearend="100"/>
					</td>
<td>
						客服专员:
						...
						<ul>
							...
							<li>
								<div class="buttonActive">
									<div class="buttonContent">
										<button type="button"
											onclick="getValue(document.forms['listYearStwo']);">
											清除
										</button>
									</div>
								</div>
...
<div class="panelBar">
	...
	<table class="table" layoutH="116" nowrapTD="false" width="100%">
		...
		<tbody>
			<c:forEach var="item" items="${sessionScope.liststfstyear}">
				<tr>
					<td>
						${item.subdate}
					</td>
