		...
		<div class="pageFormContent" layoutH="56">
			...
			<fieldset>
				...
				<p>
					...
					<input type="text" name="orderdealinfoForm.occtime" class="date"
						readonly="true" size="30" format="yyyy-MM-dd HH:mm:ss" value="${orderdealinfoForm.occtime}"/>
			...
			<fieldset>
				<p>
					...
					<input type="text" name="orderdealinfoForm.dealtime" class="date"
						readonly="true" size="30" format="yyyy-MM-dd HH:mm:ss" value="${orderdealinfoForm.dealtime}"/>
					<a class="inputDateButton" href="javascript:;">选择</a>
				</p>
				<dl class="nowrap">
					<dt>
