...
public interface OrderdealinfoDAO {
    ...
    public java.util.List<com.liveneo.plat.hibernate.dao.Orderdealinfo> findByCriteria(org.hibernate.criterion.DetachedCriteria detachedCriteria);
	public java.util.List<com.liveneo.plat.hibernate.dao.Orderdealinfo> findByCriteria(org.hibernate.criterion.DetachedCriteria detachedCriteria,int firstResult,int resultCount);
	...
	public java.util.List findByExample(com.liveneo.plat.hibernate.dao.Orderdealinfo orderdealinfo);
	...
	public	com.liveneo.plat.hibernate.dao.Orderdealinfo getByUniqueIndex(
