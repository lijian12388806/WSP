...
import com.liveneo.plat.hibernate.dao.base.BaseCusphonelistDAO;


public class CusphonelistDAO extends BaseCusphonelistDAO implements com.liveneo.plat.hibernate.dao.dao.iface.CusphonelistDAO {

	public CusphonelistDAO () {}
	
	public CusphonelistDAO (Session session) {
		super(session);
	}
	...
	public java.util.List findByNamedQuery(final String queryName,final Object parameter) {
  		final String queryString = "from com.liveneo.plat.hibernate.dao.Cusphonelist where "
			+ queryName + "= ?";
	...
	public java.util.List findByExample(com.liveneo.plat.hibernate.dao.Cusphonelist cusphonelist) {
  		return getHibernateTemplate().findByExample(cusphonelist);
    }
	...
	public	com.liveneo.plat.hibernate.dao.Cusphonelist getByUniqueIndex(
		...
		com.liveneo.plat.hibernate.dao.Cusphonelist object = (com.liveneo.plat.hibernate.dao.Cusphonelist) getHibernateTemplate()
	...
	public com.liveneo.plat.hibernate.dao.Cusphonelist getByUniqueIndex(
		...
		DetachedCriteria detachedCriteria = DetachedCriteria
				.forClass(com.liveneo.plat.hibernate.dao.Cusphonelist.class);
