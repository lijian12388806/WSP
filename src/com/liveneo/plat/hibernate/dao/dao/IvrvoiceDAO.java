...
import com.liveneo.plat.hibernate.dao.base.BaseIvrvoiceDAO;


public class IvrvoiceDAO extends BaseIvrvoiceDAO implements com.liveneo.plat.hibernate.dao.dao.iface.IvrvoiceDAO {

	public IvrvoiceDAO () {}
	
	public IvrvoiceDAO (Session session) {
		super(session);
	}
	...
	public java.util.List findByNamedQuery(final String queryName,final Object parameter) {
  		final String queryString = "from com.liveneo.plat.hibernate.dao.Ivrvoice where "
			+ queryName + "= ?";
	...
	public java.util.List findByExample(com.liveneo.plat.hibernate.dao.Ivrvoice ivrvoice) {
  		return getHibernateTemplate().findByExample(ivrvoice);
    }
	...
	public	com.liveneo.plat.hibernate.dao.Ivrvoice getByUniqueIndex(
		...
		com.liveneo.plat.hibernate.dao.Ivrvoice object = (com.liveneo.plat.hibernate.dao.Ivrvoice) getHibernateTemplate()
	...
	public com.liveneo.plat.hibernate.dao.Ivrvoice getByUniqueIndex(
		...
		DetachedCriteria detachedCriteria = DetachedCriteria
				.forClass(com.liveneo.plat.hibernate.dao.Ivrvoice.class);
