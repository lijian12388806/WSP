...
import com.liveneo.plat.hibernate.dao.base.BaseCustomerinfoDAO;


public class CustomerinfoDAO extends BaseCustomerinfoDAO implements com.liveneo.plat.hibernate.dao.dao.iface.CustomerinfoDAO {

	public CustomerinfoDAO () {}
	
	public CustomerinfoDAO (Session session) {
		super(session);
	}
	...
	public java.util.List findByNamedQuery(final String queryName,final Object parameter) {
  		final String queryString = "from com.liveneo.plat.hibernate.dao.Customerinfo where "
			+ queryName + "= ?";
	...
	public java.util.List findByExample(com.liveneo.plat.hibernate.dao.Customerinfo customerinfo) {
  		return getHibernateTemplate().findByExample(customerinfo);
    }
	...
	public	com.liveneo.plat.hibernate.dao.Customerinfo getByUniqueIndex(
		...
		com.liveneo.plat.hibernate.dao.Customerinfo object = (com.liveneo.plat.hibernate.dao.Customerinfo) getHibernateTemplate()
	...
	public com.liveneo.plat.hibernate.dao.Customerinfo getByUniqueIndex(
		...
		DetachedCriteria detachedCriteria = DetachedCriteria
				.forClass(com.liveneo.plat.hibernate.dao.Customerinfo.class);
