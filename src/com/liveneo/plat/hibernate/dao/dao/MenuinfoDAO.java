...
import com.liveneo.plat.hibernate.dao.base.BaseMenuinfoDAO;
import com.liveneo.plat.utils.PageNoUtil;


public class MenuinfoDAO extends BaseMenuinfoDAO implements com.liveneo.plat.hibernate.dao.dao.iface.MenuinfoDAO {

	public MenuinfoDAO () {}
	
	public MenuinfoDAO (Session session) {
		super(session);
	}
	...
	public java.util.List findByNamedQuery(final String queryName,final Object parameter) {
  		final String queryString = "from com.liveneo.lcp.hibernate.dao.Menuinfo where "
			+ queryName + "= ?";
	...
	public java.util.List findByExample(com.liveneo.plat.hibernate.dao.Menuinfo menuinfo) {
  		return getHibernateTemplate().findByExample(menuinfo);
    }
	...
	public	com.liveneo.plat.hibernate.dao.Menuinfo getByUniqueIndex(
		...
		com.liveneo.plat.hibernate.dao.Menuinfo object = (com.liveneo.plat.hibernate.dao.Menuinfo) getHibernateTemplate()
	...
	public com.liveneo.plat.hibernate.dao.Menuinfo getByUniqueIndex(
		...
		DetachedCriteria detachedCriteria = DetachedCriteria
				.forClass(com.liveneo.plat.hibernate.dao.Menuinfo.class);
