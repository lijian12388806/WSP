...
public abstract class _BaseRootDAO extends HibernateDaoSupport{
    ...
    private final Log log = LogFactory.getLog(getReferenceClass());
    ...
    **/
	...
	public static void initialize () {
		com.liveneo.plat.hibernate.dao.dao._RootDAO.initialize(
			(String) null);
	}
	*/
	/**
	...
	public static void initialize (String configFileName) {
		com.liveneo.plat.hibernate.dao.dao._RootDAO.initialize(
			configFileName,
			com.liveneo.plat.hibernate.dao.dao._RootDAO.getNewConfiguration(
				null));
	}
   */
    /**
	public static void initialize (String configFileName, Configuration configuration) {
		if (null != sessionFactoryMap && null != sessionFactoryMap.get(configFileName)) return;
			...
			if (null == configFileName) {
				...
				com.liveneo.plat.hibernate.dao.dao._RootDAO.setSessionFactory(
					null,
   ...
   */
    ...
    */
	...
	protected Object get(Class refClass, Serializable key) {
		log.debug("getting " + refClass + " instance with id: " + key);
		try {
	...
	public java.util.List findAll (Order defaultOrder) {
		log.debug("findAll defaultOrder " + defaultOrder);
		try {
			DetachedCriteria dc = DetachedCriteria
					.forClass(getReferenceClass());
			dc.addOrder(defaultOrder);
	 ...
	 *            HQL String
	 */
	public java.util.List find(String queryString) {
	 ...
	 * @param value
	 */
	public java.util.List find(String queryString, Object value) {
	 ...
	 * @param values
	 */
	public java.util.List find(final String queryString, final Object[] values) {
		log.debug("find queryString " + queryString);
		try {
	...
	public java.util.List findBySQL(String queryString) {
		return findBySQL(queryString, null, null);
	}

	/**
	 * Return resultCount query by DetachedCriteria
	 ...
	 * @param alias
	 */
	public java.util.List findBySQL(String queryString, String alias) {
		return findBySQL(queryString, alias, null);
	}
	...
	public java.util.List findBySQL(final String queryString, final String alias,
		...
		return (List) getHibernateTemplate().execute(new HibernateCallback() {
			public Object doInHibernate(Session session) throws HibernateException {
				...
				if (alias == null) {
					sqlQ.addEntity("default", refClass == null ? getReferenceClass() : refClass);
				} else {
	...
	protected void update(final Object obj) {
		log.debug("updating " + obj + " instance");
		try {
	...
	protected void delete(final Object obj) {
		log.debug("deleteing " + obj + " instance");
		try {
	...
	public int bulkUpdate(String queryString, Object[] values) {
		...
		try {
			int i= getHibernateTemplate().bulkUpdate(queryString, values);
			log.debug("batch data successful");
			return i;
		} catch (RuntimeException re) {
			log.error("batch data failed", re);
			throw re;
		}
	...
	public int bulkUpdate(String queryString) {
		log.debug("batch data");
		try {
			int i= getHibernateTemplate().bulkUpdate(queryString);
			log.debug("batch data successful");
			return i;
		} catch (RuntimeException re) {
			log.error("batch data failed", re);
	...
	public int bulkUpdate(String queryString, Object value) {
		log.debug("batch data");
		try {
			int i= getHibernateTemplate().bulkUpdate(queryString, value);
			log.debug("batch data successful");
			return i;
		} catch (RuntimeException re) {
			log.error("batch data failed", re);
