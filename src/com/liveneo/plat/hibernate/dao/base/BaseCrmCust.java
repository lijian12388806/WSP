...
/**
 * This is an object that contains data related to the crm_cust table.
...
public abstract class BaseCrmCust  implements Serializable {

	public static String REF = "CrmCust";
	...
	public static String PROP_WOS_PHONE = "WosPhone";
	...
	public static String PROP_WOS_NAME = "WosName";
	 ...
	 */
	public BaseCrmCust (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String wosName;
	private java.lang.String wosPhone;
	...
	/**
	 * Return the value associated with the column: WOS_NAME
	 */
	public java.lang.String getWosName () {
		return wosName;
	}

	/**
	 * Set the value related to the column: WOS_NAME
	 * @param wosName the WOS_NAME value
	 */
	public void setWosName (java.lang.String wosName) {
	...
	/**
	 * Return the value associated with the column: WOS_PHONE
	 */
	public java.lang.String getWosPhone () {
		return wosPhone;
	}

	/**
	 * Set the value related to the column: WOS_PHONE
	 * @param wosPhone the WOS_PHONE value
	 */
	public void setWosPhone (java.lang.String wosPhone) {
		this.wosPhone = wosPhone;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.liveneo.plat.hibernate.dao.CrmCust)) return false;
		else {
			com.liveneo.plat.hibernate.dao.CrmCust crmCust = (com.liveneo.plat.hibernate.dao.CrmCust) obj;
			if (null == this.getId() || null == crmCust.getId()) return false;
			else return (this.getId().equals(crmCust.getId()));
		}
	}
