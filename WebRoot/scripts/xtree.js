...
var webFXTreeConfig = {		
	rootIcon        : this.imagePath + 'images/treeimg/base.gif',
	openRootIcon    : this.imagePath + 'images/treeimg/base.gif',
	folderIcon      :  this.imagePath + 'images/treeimg/folder.gif',
	openFolderIcon  :this.imagePath + 'images/treeimg/folderopen.gif',
	fileIcon        : this.imagePath + 'images/treeimg/page.gif',
	iIcon           : this.imagePath + 'images/treeimg/I.png',
	lIcon           : this.imagePath + 'images/treeimg/L.png',
	lMinusIcon      : this.imagePath + 'images/treeimg/Lminus.png',
	lPlusIcon       : this.imagePath + 'images/treeimg/Lplus.png',
	tIcon           : this.imagePath + 'images/treeimg/T.png',
	tMinusIcon   : this.imagePath + 'images/treeimg/Tminus.png',
	tPlusIcon       : this.imagePath + 'images/treeimg/Tplus.png',
	blankIcon       : this.imagePath + 'images/treeimg/blank.png',
	...
	setImagePath: function(path){  // 设置图片路径。直接设置 imagePath 属性不起作用。
        ...
        //this.imagePath = path;
		this.rootIcon = path + "images/treeimg/base.gif";
		this.openRootIcon = path + 'images/treeimg/base.gif';
		this.folderIcon     =  path + 'images/treeimg/folder.gif';
		this.openFolderIcon  = path + 'images/treeimg/folderopen.gif';
		this.fileIcon       = path + 'images/treeimg/page.gif';
		this.iIcon           = path + 'images/treeimg/I.png';
		this.lIcon           = path + 'images/treeimg/L.png';
		this.lMinusIcon   =  path + 'images/treeimg/Lminus.png';
		this.lPlusIcon     = path + 'images/treeimg/Lplus.png';
		this.tIcon          = path + 'images/treeimg/T.png';
		this.tMinusIcon  = path + 'images/treeimg/Tminus.png';
		this.tPlusIcon     = path + 'images/treeimg/Tplus.png';
		this.blankIcon     = path + 'images/treeimg/blank.png';
	}	
