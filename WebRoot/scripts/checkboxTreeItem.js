...
function WebFXCheckBoxTreeItem(sText, sValue,eParent, sIcon, sOpenIcon, bChecked, disabled,sBoxName) {
	...
	this.boxname=sBoxName==null?sValue:sBoxName;	
...
WebFXCheckBoxTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	var tempStr = "<input type=\"checkbox\"" + " class=\"tree-check-box\"" +
		...
		" value=\"" + this.value + "\" id=\"" + this.id + "-input\" name=\"" + this.boxname 
