...
<form id="pagerForm" method="post"
	onsubmit="return divSearch(this, 'jbsxBox_order_${wo_ucid}');"
	action="${applicationScope.rootpath}listworkoder_his.action?his_N=${his_N}&querycallerno=${workOrderForm.callerno}&wo_ucid=${wo_ucid}">
...
<div class="lcp_div_left" style="margin-top: 10px; width: 100%;">
	...
	<div class="pages">
		...
		<select name="numPerPage" onchange="navTabPageBreak({numPerPage:this.value}, 'jbsxBox_order_${wo_ucid}')">
	...
	<div class="pagination" targetType="navTab" rel="jbsxBox_order_${wo_ucid}" totalCount="${totalCount}" numPerPage="${numPerPage}" pageNumShown="10" currentPage="${param.pageNum}"></div>
</div>
</div>