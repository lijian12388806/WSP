			...
			<fieldset>
				...
				<p>
					...
					<c:forEach items="${applicationScope.dictpara['WorkOrderStatus']}"
							var="activeState">
						<c:if test="${orderdealinfoForm.wostatus == activeState.code}">
							<input name="orderdealinfoForm.wostatus" id="orderdealinfoForm.wostatus" type="text" value="${activeState.title}" readonly="readonly"/>
						</c:if>
					</c:forEach>
				</p>
			</fieldset>
