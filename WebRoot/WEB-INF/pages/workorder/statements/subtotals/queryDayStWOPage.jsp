...
<form id="pagerForm" method="post"
	action="${applicationScope.rootpath}listDayStwo.action">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="listDayStwo.action"
		method="post" name="listDayStwo">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td>
						统计时间:
						<input name="querystwoday" id="querystwoday"
							value="${querystwoday}" type="text" size="20" class="date"
							format="yyyy-MM-dd" yearstart="0" yearend="100" />
					</td>
					<td>
						客服专员:
							...
							<ul>
								...
								<li>
									<div class="buttonActive">
										<div class="buttonContent">
											<button type="button"
												onclick="getValue(document.forms['listDayStwo']);">
												清除
											</button>
										</div>
									</div>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li>
				<a class="icon"
					href="${applicationScope.rootpath}download.action?loadflag=wo&fileName=${fileName}"
	...
	<table class="table" layoutH="116" nowrapTD="false" width="100%">
		...
		<tbody>
			<c:forEach var="item" items="${sessionScope.liststfstday}">
				<tr>
					<td>
						${item.subdate}
					</td>
